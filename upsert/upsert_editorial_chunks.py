...
def upsert_chunk_batch(file_path: str) -> None:
    """
    Validate and upsert editorial chunks using text2vec-transformers.
    """
    ...
    # --------------------------------------------------
    # 3. Batch Insert (vectors generated by transformers)
    # --------------------------------------------------
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Upsert Editorial Chunks (text2vec-transformers)"
    )
    parser.add_argument(
        "--file",
        required=True,
